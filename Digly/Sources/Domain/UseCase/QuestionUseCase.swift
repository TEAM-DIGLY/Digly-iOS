...
final class QuestionUseCase {
    ...
    func submitQuestion(email: String, title: String, content: String) async throws -> QuestionResult {
        return try await questionRepository.createQuestion(email: email, title: title, content: content)
    }
